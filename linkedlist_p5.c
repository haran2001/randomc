//program to delete a particular node p, from a linked list x
#include<stdlib.h>
...
void delete(struct node *p)
{
        ...
        if(x==NULL)
                printf("No nodes avalable");                                                                                                                                                                 else                                                                                                                                                                                                 {                                                                                                                                                                                                            if(p==NULL)
...
void main()
{
        ...
        else                                                                                                                                                                                                 {                                                                                                                                                                                                            if(head==NULL)                                                                                                                                                                                               printf("No nodes available\n");
                else                                                                                                                                                                                                 {                                                                                                                                                                                                            for(i=1;i<loc;i++)
                                p=p->link;
                        delete(p);                                                                                                                                                                                   }                                                                                                                                                                                            }
        //display nodes again                                                                                                                                                                                printf("The circular linked list displayed after deletion of node\n");
        display_CLL();    
	 printf("\n");
